...
const NAV_ITEMS: NavItem[] = [
  ...
  { key: "checkin-log", label: "Chấm công selfie", group: "VẬN HÀNH", icon: ScanFace },
  { key: "leave", label: "Nghỉ phép", group: "VẬN HÀNH", icon: CalendarDays },
...
const ROLE_SCREENS: Record<string, string[]> = {
  ...
  lead: ["framework", "dashboard", "employees", "org", "attendance", "checkin-log", "leave", "report", "kpi"],
...
const PAGE_META: Record<string, { title: string; subtitle: string }> = {
  ...
  leave: { title: "Nghỉ phép", subtitle: "Đơn nghỉ phép & số dư phép" },
