...
const IMPORT_HEADER_MAP: Record<string, string> = {
  ...
  "chi nhánh ngân hàng": "bank_branch", // gộp về "Ngân hàng" — không hiển thị riêng, chỉ nhận để không báo "chưa hỗ trợ"
...
const FIELD_LABELS: Record<string, string> = {
  ...
  bhxh_no: "Mã số sổ BHXH", bhxh_increase_date: "Báo tăng BHXH",
...
const IMPORT_COMPARE_FIELDS = [
  ...
  "nationality", "religion", "ethnicity", "bank_account", "bhxh_no",
