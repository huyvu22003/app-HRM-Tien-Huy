...
const FIELD_LABELS: Record<string, string> = {
  ...
  bank_branch: "Chi nhánh ngân hàng", bhxh_no: "Mã số sổ BHXH", bhxh_increase_date: "Báo tăng BHXH",
...
const IMPORT_COMPARE_FIELDS = [
  ...
  "birth_place", "education", "specialization", "temp_address", "cccd_issue_date", "cccd_issue_place",
...
const FULL_EXPORT_COLUMNS: FullExportCol[] = [
  ...
  { label: "Năm sinh", value: (e) => exDate(e.dob) || e.birth_year || "" },
  { label: "Nơi sinh", value: (e) => e.birth_place ?? "" },
  { label: "Học lực", value: (e) => e.education ?? "" },
  { label: "Chuyên môn", value: (e) => e.specialization ?? "" },
...
export function EmployeesScreen({ onNavigate }: { onNavigate: (screen: string, id?: string) => void }) {
  ...
  const columns: ColumnDef<ApiEmployee>[] = [
    ...
    textCol("specialization", "Chuyên môn"),
    textCol("address", "Địa chỉ thường trú"),
    textCol("temp_address", "Địa chỉ tạm trú"),
    textCol("cccd", "Số CCCD"),
    ...
    moneyCol("base_salary", "Lương cơ bản"),
    moneyCol("responsibility_salary", "Trách nhiệm"),
    moneyCol("allowance", "PC công việc"),
